...
<li>
	 ...
	 <?php if ( (function_exists('the_post_thumbnail')) && (has_post_thumbnail()) ) :
	    ...
	    <a href="<?php the_permalink(); ?>"><img src="<?php echo $featured_post_plugin_path ?>scripts/timthumb.php?src=<?php echo catch_that_image() ?>&amp;h=<?php echo $height_thumb ?>&amp;w=<?php echo $width_thumb ?>&amp;zc=1" class="alignleft" alt="<?php the_title(); ?>" /> </a>
	    <?php endif; ?>
</li>
   <?php
   endforeach;
