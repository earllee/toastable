	...
	<?php } else { //No registration required ?>
		...
		<?php } else { //If user is not logged in ?>
			...
			<div class="col-right">
				...
				<p>
					<input type="text" name="twitter" class="txt" id="twitter" value="<?php echo $comment_author_url; ?>" size="22" tabindex="3" />
					<label for="twitter" class="twitter-label"><?php _e( 'Twitter Username', 'woothemes' ); ?></label>
				</p>
				
				<p>
					<input type="text" name="facebook" class="txt" id="facebook" value="<?php echo $comment_author_url; ?>" size="22" tabindex="3" />
