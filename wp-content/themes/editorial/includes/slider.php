            ...
            <div id="slide-<?php echo $count; ?>" class="slide">
        		<?php
        			if ( ( $has_embed == true ) && ( $slide_content == 'video' ) ) {
        				echo woo_embed( 'key=embed&width=940&class=slide-video' );
        			} else {
        				woo_image( 'key=image&width=940&h=&class=slide-image&link=img' );
        			}
        		?>
            	...
            	<div class="slide-content post">
       		    ...
       		    <div class="fix"></div>
        	<input type="hidden" name="transition" value="<?php echo $slide_transition; ?>" />
            </div><!--/.slide-->
