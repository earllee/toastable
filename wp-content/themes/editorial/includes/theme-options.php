...
if ( ( get_post_type() == 'post') || ( !get_post_type() ) ) {
	...
	$woo_metaboxes[] = array (	"name" => "_slide_transition_type",
								"std" => "scrollHorz",
								"label" => "Slide Effect",
								"type" => "select2",
								"desc" => "Specify what slide transition you would like to use for this post.",
								"options" => array(	
	...
	$woo_metaboxes[] = array ( 	"name" => "_enable_gallery",
								"label" => "Enable Gallery/Featured Image", 
								"desc" => "Enable the gallery for this entry.",
								"std" => "true",
								"class" => "collapsed",
								"type" => "checkbox" );
