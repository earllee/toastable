...
function thesis_404_title() {
	_e('Woops! You wrote down the wrong recipe!', 'thesis');
}

function thesis_404_content() {
?>
<p><?php _e('Try using the search bar to find the right recipe, or you can experiment and make your own!', 'thesis'); ?></p>
<ul>
	<li><?php _e('You can also try Google search!', 'thesis'); ?></li>
	<li><?php printf(__('Go back <a href="%s" rel="nofollow">home</a>.', 'thesis'), get_bloginfo('url')); ?></li>
</ul>
<?php	
}
