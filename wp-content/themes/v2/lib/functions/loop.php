...
function thesis_post_content($post_count = false, $post_image = false) {
	...
	elseif (((is_home() || is_archive() || is_search()) && $thesis_design->display['posts']['excerpts']) || ((is_archive() || is_search()) && $thesis_design->display['archives']['style'] == 'excerpts'))
		the_excerpt();
	else 
the_content('<img class="readmore" src="http://toastable.com/wp-content/themes/v2/custom/images/more-link.gif">');
