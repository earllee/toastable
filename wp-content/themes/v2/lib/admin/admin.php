...
function thesis_add_menu() {
	global $menu, $wp_version, $thesis_header;
...
function thesis_options_nav($depth = 1) {
	...
	echo "$indent\t<li><a href=\"http://diythemes.com/thesis/rtfm/\">Thesis User&#8217;s Guide</a></li>\n";
	echo "$indent\t<li><a href=\"http://diythemes.com/forums/\">Support Forums</a></li>\n";
	echo "$indent\t<li><a href=\"http://diythemes.com/affiliate-program/\">Affiliate Program</a></li>\n";
	echo "$indent</ul>\n";
}
